...
class Fighter: Spaceship {
  ...
  func fire( shots: Int = 1) {
    if remainingFirePower > 0 {
      remainingFirePower -= shots
    } else {
...
destroyer.moveRight()
print("\(destroyer.name) is at \(destroyer.position)")
...
// No instance of either class names falcon
