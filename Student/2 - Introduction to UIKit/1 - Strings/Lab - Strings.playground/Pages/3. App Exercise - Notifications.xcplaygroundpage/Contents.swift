 ...
 */
let first = "John", last = "Doe", full = "\(first) \(last)"
print( full )
...
print("Congratulations, \(full))! You beat your previous daily high score of \(previousBest) steps by walking \(newBest) steps yesterday!")
/*:
