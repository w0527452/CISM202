 ...
 */
var walkingChallenges = ["Walk everyday", "Walk to work", "Walk around block"]
var runningChallenges = ["Run everyday", "Run for 1 hour", "Run 4 miles"]
...
} else if commitments.count == 1 {
  print("The challenge you have chosen is \(commitments[0])")
} else {
