...
struct Book {
  var title: String, author: String, pages: Int, price: Double
}
var favoriteBook = Book(title: "A Book", author: "Joe", pages: 12, price: 5.5)
print( "\(favoriteBook.title) by \(favoriteBook.author) is \(favoriteBook.pages) pages for $\(favoriteBook.price)")
 ...
 */
struct Height {
  var heightInInches: Double, heightInCentimeters: Double
  init(inches: Double) {
...
print("someonesHeight: \(someonesHeight.heightInCentimeters)")
...
let myHeight = Height(inches: 70)
print("myHeight inches: \(myHeight.heightInInches) myHeight centimeters: \(myHeight.heightInCentimeters)")
