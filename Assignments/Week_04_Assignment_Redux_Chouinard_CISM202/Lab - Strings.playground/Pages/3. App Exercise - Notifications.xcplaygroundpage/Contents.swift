 ...
 */
let firstName = "Mark", lastName = "Chouinard", fullName = firstName + " " + lastName
print( fullName )
...
let newBest = 15125
let congrats = "Congratulations \(fullName) you beat you last high of \(previousBest) steps by walking \(newBest) yesterday"
print(congrats)
/*:
