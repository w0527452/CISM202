...
class QuestionViewController: UIViewController {
  ...
  var questions: [Question] = [
    Question(text: "Which food is best?", type: .single,
             answers: [
    ...
    Question(text: "Car rides?",
             type: .multiple,
             answers: [
              Answer(text: "Dislike", type: .cat),
              Answer(text: "Get nervous", type: .rabbit),
  ...
  @IBAction func multiSubmitTapped() {
    let currentAnswers = questions[questionIndex].answers
  ...
  @IBAction func rangedSubmitTapped() {
    let currentAnswerss = questions[questionIndex].answers
    let index = Int(round(rangedSlider.value * Float(currentAnswerss.count - 1 ) ) )

    chosenAnswers.append(currentAnswerss[index])
