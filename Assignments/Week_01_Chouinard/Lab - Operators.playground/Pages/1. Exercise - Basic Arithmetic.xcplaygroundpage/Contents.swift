 ...
 */
let width = 10, height = 20, area = width * height
print(area)
...
let double10: Double = 10, double3: Double = 3, divisionResult = double10/double3
 ...
 */
let pi = 3.1415927, radius: Double = 5, diameter = 2 * radius, circumference = 2 * pi * radius
...
let even = 2, odd = 3
print( even % 2, odd % 2 )
print("If dividing by 2 gives remainder of 0 the number is even")
