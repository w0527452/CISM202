 ...
 */
let heartRate1 = 65, heartRate2 = 75, heartRate3 = 85, addedHR = heartRate1 + heartRate2 + heartRate3
...
let heartRate1D: Double = 65, heartRate2D: Double = 75, heartRate3D: Double = 85, addedHRD = heartRate1D + heartRate2D + heartRate3D
let averageHRD = addedHRD / 3
print(averageHRD)
print("It prints the same value as a double")
...
let steps: Double = 3_467, goal: Double = 10_000, percentOfGoal = steps / goal
print(percentOfGoal)
